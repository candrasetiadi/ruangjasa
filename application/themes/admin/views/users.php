<script src="{base_url()}assets/js/views/users.js"></script>
<script>
...
<div id="addForm" class="modal fade" tabindex="-1" data-width="1290" style="display: none;" data-focus-on="input:first" >
	...
	<div class="modal-body">
	    <form role="form" class="parsley-validate ajax" action="{site_url('admin/users/process')}" done="confirmAgain()" clearform>
				...
				<div class="row">
					<div class="col-md-6">
				        ...
				        <div class="form-group">
				            ...
				            <input type="password" id="confirm" name="confirm" class="form-control" required data-parsley-equalto="#user_password"/>
				        </div>
					...
					<div class="col-md-6">
				        ...
				        <div class="form-group">
				            ...
				            <select class="chosen-select" name="user_province_id" id="user_province_id">
		                        <option value="0"></option>
				        ...
				        <div class="form-group">
				            ...
				            <select class="chosen-select" name="user_city_id" id="user_city_id">
		                        <option value="0"></option>
		                    </select>
				        </div>
				        <div class="form-group">
				            <label for="user_district_id">Districts:</label>
				            <select class="chosen-select" name="user_district_id" id="user_district_id">
		                        <option value="0"></option>
		                    </select>
				        </div>
				        <div class="form-group">
				            <label for="user_phone">Phone:</label>
				            <input type="text" id="user_phone" name="user_phone" class="form-control" required data-parsley-cek_phone="" placeholder="0815 XXXX XXXX" />
				        </div>
					</div>
				</div>
			</form>
