<script src="{base_url()}assets/js/views/lesson.js"></script>
<script>
...
<div id="addForm" class="modal fade" tabindex="-1" data-width="430" style="display: none;" data-focus-on="input:first" >
	...
	<div class="modal-body">
	    <form role="form" class="parsley-validate ajax" action="{site_url('admin/lesson/process')}" done="confirmAgain()" clearform>
				        ...
				        <div class="form-group">
				            ...
				            <select class="chosen-select" name="lesson_category_id" id="lesson_category_id">
					            ...
					            {foreach $category val}
								  	<option value="{$val->lesson_category_id}">{$val->lesson_category_name}</option>
								{/foreach}
		                    </select>
				        </div>
					</div>
