...
<!-- Breadcrumb End -->
	...
	<!-- Page Start -->
    <header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url('<?php echo base_url();?>assets/client/images/img_bg_1.jpg');" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4 howto">
						<img class="img-responsive img-howto" src="<?php echo base_url();?>assets/client/images/1.jpg" alt="work">
						<div class="mt">
							<h3>Jelaskan Kebutuhan Anda</h3>
							<p>Beritahu kami secara lengkap tentang layanan yang anda butuhkan</p>
						</div>
					</div>
					<div class="col-sm-4 howto">
						<img class="img-responsive img-howto" src="<?php echo base_url();?>assets/client/images/2.jpg" alt="work">
						<div class="mt">
							<h3>Dapatkan Penawaran Dalam Beberapa Jam</h3>
						<p>Kami akan mengirimkan beberapa penawaran melalui email anda</p>
						</div>
					</div>
					<div class="col-sm-4 howto">
						<img class="img-responsive img-howto" src="<?php echo base_url();?>assets/client/images/3.jpg" alt="work">
						<div class="mt">
							<h3>Pilih Yang Terbaik</h3>
							<p>Bandingkan harga, portfolio and review dari penyedia jasa</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/serviceac.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive top-category">
						<h3>Service AC</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/kontraktor.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive top-category">
						<h3>Kontraktor Bangunan</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/interior.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive top-category">
						<h3>Interior Design</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/tukang.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive top-category">
						<h3>Jasa Pertukangan</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/perkakas.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive top-category">
						<h3>Service Perkakas</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/pindahan.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive top-category">
						<h3>Jasa Pindahan</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<?php echo base_url();?>assets/client/images/person_1.jpg" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<?php echo base_url();?>assets/client/images/person_2.jpg" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<?php echo base_url();?>assets/client/images/person_3.jpg" alt="user">
									</figure>
									<span>John Doe, via <a href="#" class="twitter">Twitter</a></span>
									<blockquote>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive" src="<?php echo base_url();?>assets/client/images/jasa/serviceac.jpg" alt=""></a>
						<div class="blog-text">
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive" src="<?php echo base_url();?>assets/client/images/project-2.jpg" alt=""></a>
						<div class="blog-text">
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive" src="<?php echo base_url();?>assets/client/images/project-3.jpg" alt=""></a>
						<div class="blog-text">
