        ...
        <nav class="fh5co-nav" role="navigation">
            ...
            <div class="top-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-1">
                            <div id="fh5co-logo"><a href="<?php echo base_url();?>">Ruangjasa<span>.</span>com</a></div>
                        </div>
                        <div class="col-xs-11 text-right menu-1">
                            <ul>
                                <!-- <li><a href="courses.html">Cara Kerja</a></li> -->
                                <li><a href="<?php echo base_url('business');?>">Menjadi Penyedia Jasa</a></li>
                                ...
                                <li class="btn-cta"><a href="<?php echo site_url('login/register');?>"><span>Register</span></a></li>
                            </ul>
                        </div>
                    </div>
