	...
	<div id="fh5co-explore" class="fh5co-bg-section">
		...
		<div class="fh5co-explore fh5co-explore1">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/1.jpg" alt="work">
					</div>
					<div class="col-sm-4">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/1.jpg" alt="work">
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-pull-1 animate-box">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/2.jpg" alt="work">
					</div>
		...
		<div class="fh5co-explore fh5co-explore1">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-push-5 animate-box">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/3.jpg" alt="work">
					</div>
					<div class="col-md-4 col-md-pull-8 animate-box">
						<div class="mt">
