...
<!-- Breadcrumb End -->
	...
	<!-- Page Start -->
    <header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url('<?php echo base_url();?>assets/clienet/images/img_bg_1.jpg');" data-stellar-background-ratio="0.5">
