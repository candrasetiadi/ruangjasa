...
echo $this->arrayMap('var_dump', array((isset($this->scope["test"]) ? $this->scope["test"] : null)));?>

<script src="<?php echo base_url();?>assets/js/views/news.js"></script>
<script>
...
<div id="addForm" class="modal fade" tabindex="-1" data-width="800" style="display: none;" data-focus-on="input:first" >
	...
	<div class="modal-body">
	    <form role="form" class="parsley-validate ajax" action="<?php echo site_url('admin/news/process');?>" done="confirmAgain()" clearform>
