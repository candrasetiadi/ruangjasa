<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><script src="<?php echo base_url();?>assets/js/views/request_form_options.js"></script>
<script>
...
<div id="addForm" class="modal fade" tabindex="-1" data-width="430" style="display: none;" data-focus-on="input:first" >
	...
	<div class="modal-body">
	    <form role="form" class="parsley-validate ajax" action="<?php echo site_url('admin/services/process_request_form_options');?>" done="confirmAgain()" clearform>
					...
					<div class="col-md-12">
						<div class="form-group">
				            ...
				            <select class="chosen-select" name="services_request_form_id" id="services_request_form_id">
		                        ...
		                        <?php 
$_fh0_data = (isset($this->scope["form"]) ? $this->scope["form"] : null);
...
?>
									<option value="<?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'services_request_form_id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["val"], false);?>"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'services_request_form_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["val"], false);?></option>
								<?php 
/* -- foreach end output */
	}
}?>
