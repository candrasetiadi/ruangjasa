					...
					<form action="#">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Jelaskan terhadap cutomer tentang usaha anda<br>- Keunggulan jasa anda<br>- Cara Kerja anda<br>- Metode pembayaran"></textarea>
							</div>
						</div>
