			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4 howto">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/1.jpg" alt="work" vertical-align="middle">
						<div class="mt">
					...
					<div class="col-sm-4 howto">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/2.jpg" alt="work" align="middle">
						<div class="mt">
					...
					<div class="col-sm-4 howto">
						<img class="img-responsive" src="<?php echo base_url();?>assets/client/images/3.jpg" alt="work" align="middle">
						<div class="mt">
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/serviceac.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Service AC</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/kontraktor.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Kontraktor Bangunan</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/interior.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Interior Design</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/tukang.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Jasa Pertukangan</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/perkakas.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Service Perkakas</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/client/images/jasa/pindahan.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Jasa Pindahan</h3>
						<span>Pesan Sekarang</span>
					</a>
				</div>
